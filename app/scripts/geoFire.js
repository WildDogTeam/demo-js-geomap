 ...
 * @constructor
 * @this {GeoFire}
 * @param {wilddog} wilddogRef A wilddog reference where the GeoFire data will be stored.
 */
var GeoFire = function(wilddogRef) {
  /********************/
  /*  PUBLIC METHODS  */
  /********************/
  /**
   * Returns the wilddog instance used to create this GeoFire instance.
   *
   * @return {wilddog} The wilddog instance used to create this GeoFire instance.
   */
  this.ref = function() {
    return _wilddogRef;
  };
  ...
  /**
   * Adds the provided key - location pair(s) to wilddog. Returns an empty promise which is fulfilled when the write is complete.
   *
